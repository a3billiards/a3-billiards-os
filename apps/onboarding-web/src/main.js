...
ReactDOM.createRoot(document.getElementById("root")).render(_jsx(React.StrictMode, { children: _jsx(ConvexAuthProvider, { client: convex, children: _jsx(BrowserRouter, { children: _jsx(App, {}) }) }) }));
