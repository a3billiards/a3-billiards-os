...
export default function CustomerHelpScreen(): React.JSX.Element {
    ...
    <GlassPageBackground>
      <SafeAreaView style={styles.safe} edges={["top"]}>
        <View style={styles.nav}>
          ...
          <Text style={styles.navTitle}>{t("customerApp.help.title")}</Text>
        ...
        >
          <HelpSupportPanel
            audience="customer"
            faqIds={CUSTOMER_FAQ_IDS}
            faqKeyPrefix="customerApp.help.faq"
            t={t}
