/** English error strings — mirrors @a3/ui/errors ERROR_CODES. */
export const errorMessagesEn = {
  ...
  SESSION_002:
    "Table lock invalid, expired, or held by another device — please retry",
  ...
  BOOKING_003: "Concurrent booking conflict — please retry",
  ...
  RATE_001: "Rate limit exceeded — please retry later",
  ...
  PROMOTE_001:
    "Customers cannot be promoted. Register via Onboarding Website.",
  PROMOTE_002: "User is already an admin.",
  PROMOTE_003:
    "Owner must have email+password login before admin promotion",
