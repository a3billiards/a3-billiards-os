...
export interface PasscodeSetupModalProps {}
 
export function PasscodeSetupModal(_props: PasscodeSetupModalProps): React.JSX.Element {
  return (
    <View style={styles.container}>
      <Text style={styles.label}>PasscodeSetupModal</Text>
